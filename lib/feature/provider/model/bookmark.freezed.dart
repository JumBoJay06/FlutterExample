...
class _$BookmarkCopyWithImpl<$Res, $Val extends Bookmark>
  ...
  @override
  $Res call({Object? title = null, Object? subtitle = null}) {
    return _then(
      _value.copyWith(
            title:
                null == title
...
class _$BookmarkImpl implements _Bookmark {
  const _$BookmarkImpl({required this.title, required this.subtitle});
  ...
  @override
  String toString() {
    return 'Bookmark(title: $title, subtitle: $subtitle)';
  }
